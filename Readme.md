...
# Data insertion in postgres 

The required querries are given in the db_scripts folder. 
execute it to create the tables. 

Then execute the insert scripts to insert the data 
...
INSERT INTO sar.processing_job (job_name, engine, pipeline_type, job_status, scene_id, region_wkt) VALUES ( 'Jan 2026 GRD Preprocess - Scotland Tile 3', 'SPARK', 'PREPROCESS', 'CREATED', 5, 'POLYGON((-3.50 56.50,-3.40 56.50,-3.40 56.60,-3.50 56.60,-3.50 56.50))');
INSERT INTO sar.processing_job (job_name, engine, pipeline_type, job_status, scene_id, region_wkt) VALUES ( 'Jan 2026 GRD Preprocess - Scotland Tile 3', 'DASK', 'PREPROCESS', 'CREATED', 6, 'POLYGON((-3.50 56.50,-3.40 56.50,-3.40 56.60,-3.50 56.60,-3.50 56.50))');
INSERT INTO sar.processing_job (job_name, engine, pipeline_type, job_status, scene_id, region_wkt) VALUES ( 'Jan 2026 GRD Preprocess - Scotland Tile 3', 'DASK', 'PREPROCESS', 'CREATED', 7, 'POLYGON((-3.50 56.50,-3.40 56.50,-3.40 56.60,-3.50 56.60,-3.50 56.50))');



#  Debugging 

Below are the debugging scripts 

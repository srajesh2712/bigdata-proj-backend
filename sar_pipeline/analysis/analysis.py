...
file_1  = 'E:\\Big Data\\Summer Project\\Assam-Flood-June5-2024\\Flood-June5-2024\\20240605\\subset_0_of_S1A_IW_GRDH_1SDV_20240605T115717_20240605T115742_054188_06970B_2DFB_Orb_Cal_Spk_TC.tif'
file_2 = 'E:\\Big Data\\Summer Project\\Assam-Flood-June5-2024\\Preflood-May24-2024\\20240524\\subset_3_of_S1A_IW_GRDH_1SDV_20240524T115717_20240524T115742_054013_069101_5DC9_Orb_Cal_Spk_TC.tif'
...
with rasterio.open(file_1) as src_pre, rasterio.open(file_2) as src_post:
    ...
    with rasterio.open(output_path, "w", **profile) as dst:
        ...
        for y in range(0, height, tile_size):
            for x in range(0, width, tile_size):
                ...
                mask_tile = (diff_tile < -0.5).astype(np.uint8)
                #print(mask_tile)
...
# Create a colormap: 0 → black, 1 → blue
cmap = ListedColormap(["blue","white"])

# Plot
plt.figure(figsize=(8, 8))
plt.imshow(mask, cmap=cmap, vmin=0, vmax=1)  # force value range for cmap
